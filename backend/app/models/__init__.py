...
class User(Base):
    ...
    payment_identifier = Column(String)
    payout_method = Column(String)
    payout_provider = Column(String)
    payout_identifier = Column(String)
    payout_name = Column(String)
    paystack_customer_id = Column(String)
